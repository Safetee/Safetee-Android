package com.getsafeteeapp.circleoffriends;
...
import com.getsafeteeapp.circleoffriends.adapters.MessageAdapter;
...
public class MessageDialogBox extends DialogFragment {
    ...
    private static MainActivity2 objCircleOfTrustFragment;
     ...
     */
    public static MessageDialogBox newInstance(MainActivity2 objCircleOfTrustFragment, Activity activity)
    {
