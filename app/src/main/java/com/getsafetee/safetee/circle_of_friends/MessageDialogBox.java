...
import com.getsafetee.safetee.MainActivity;
...
public class MessageDialogBox extends DialogFragment {
    ...
    private static MainActivity objCircleOfTrustFragment;
     ...
     */
    public static MessageDialogBox newInstance(MainActivity objCircleOfTrustFragment, Activity activity)
    {
