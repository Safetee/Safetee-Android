package com.getsafetee.safetee.fragments;
...
import com.getsafetee.safetee.RecordingService;
import com.getsafetee.safetee.activities.VoiceRecorderMainActivity;
import com.getsafetee.safetee.listeners.SimpleAnimationListener;
import com.getsafetee.safetee.views.RecordingStateView;
import com.getsafetee.safetee.views.SoundLevelBarsView;

import java.text.SimpleDateFormat;
import java.util.Locale;


public class RecordingStatusFragment extends Fragment implements RecordingService.OnTimerChangedListener {
			...
			public void onClick(View v) {
				...
				alertDialog.setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which) {
						((VoiceRecorderMainActivity) getActivity()).setPrettyName(input.getText().toString());
					}
				});
