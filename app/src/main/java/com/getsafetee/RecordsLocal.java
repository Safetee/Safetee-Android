...
public class RecordsLocal extends AppCompatActivity implements RecordingService.OnAudioLevelChangedListener {
    ...
    private ServiceConnection mConnection = new ServiceConnection() {
        public void onServiceConnected(ComponentName className, IBinder service) {
            ...
            mRecordingService.setOnAudioLevelChanged(RecordsLocal.this);
            if (mRecordingQueued) {
    ...
    private void doBindService() {
        bindService(new Intent(RecordsLocal.this,
